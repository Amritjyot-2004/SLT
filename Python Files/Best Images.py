...
def select_best_images(input_folder, output_folder, top_n = 3512):
...
if __name__=="__main__":
    ...
    output_folder = "D:/Projects/Sign Language Translation/Dataset/L"
    select_best_images(input_folder, output_folder, top_n=3550)
